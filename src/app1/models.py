...
class Club(models.Model):
    ...
    head_email = models.CharField(max_length=225)  # Field name made lowercase.



class Department(models.Model):
    head_email = models.CharField(max_length=255, blank=True, null=True)  # Field name made lowercase.
